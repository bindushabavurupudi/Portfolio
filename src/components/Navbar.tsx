      ...
      >
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              href="public\Bindusha_Resume.pdf"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-64 glass-card neon-border animate-[slide-in-right_0.3s_ease-out] flex flex-col p-6"
            ...
            <a href="public\Bindusha_Resume.pdf" className="glow-button mt-6 flex items-center justify-center gap-2 text-sm" target='_blank'>
